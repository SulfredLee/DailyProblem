...
import sfdevtoolslight.devTools.HDTimer as HDTimer
import sfdevtoolslight.devTools.MsgQ as MsgQ
import sfdevtoolslight.devTools.AtomicData as AtomicData
import sfdevtoolslight.devTools.DiscontinueSleep as DSleep

class ThreadQ(object):
    def __init__(self):
        self.__logger: logging.Logger = None
        self._msg_q: MsgQ.MsgQ = None
        self._d_sleep: DSleep.DiscontinueSleep = None
    ...
    def init_component(self
        ...
        self._d_sleep = DSleep.DiscontinueSleep(sleep_time_ms=sleep_time_ms)
