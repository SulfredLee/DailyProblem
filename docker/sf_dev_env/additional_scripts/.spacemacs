...
before packages are loaded."
  ...
  ;; (setq ycmd-server-command '("python" "/home/sulfred/Downloads/SoftwareInstall/ycmd/ycmd"))
  ;; (setq ycmd-force-semantic-completion t)
  ;; (setq company-ycmd-request-sync-timeout 0)
  (setq x-select-enable-clipboard t)
  (setq read-file-name-completion-ignore-case t)
  ;; start git grep for whole repo
  (defun my-helm-grep-do-git-grep (arg)
    (interactive "P")
    (helm-grep-git-1 default-directory (null arg)))
  ;; end git grep for whole repo
  (spacemacs/set-leader-keys
    "sr" 'replace-string
    "gg" 'my-helm-grep-do-git-grep
    "fn" 'find-name-dired)
  (add-to-list 'auto-mode-alist '("\\.mq5$" . c++-mode))
  (add-to-list 'auto-mode-alist '("\\.mq4$" . c++-mode))
  (add-to-list 'auto-mode-alist '("\\.mqh$" . c++-mode))
  ;; handle tern for javascript auto complete
  (add-to-list 'load-path "/home/sulfred/.emacs.d/private/tern/emacs")
